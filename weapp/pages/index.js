...
_core["default"].page({
...
}, {info: {"components":{"list":{"path":"../components/wepy-list"},"group":{"path":"../components/group"},"panel":{"path":"../components/panel"},"counter":{"path":"../components/counter"},"slide-view":{"path":"../$vendor/miniprogram-slide-view/miniprogram_dist/index"}},"on":{"7-78":["index-emit"]}}, handlers: {'7-73': {"tap": function proxy () {
  ...
  }},'7-78': {"index-emit": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
